	...
	function simpan_guru(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_guru->simpan_guru($nip,$nama,$jabatan,$jenkel,$tmp_lahir,$tgl_lahir,$mapel,$photo);
					...
					$this->m_guru->simpan_guru_tanpa_img($nip,$nama,$jabatan,$jenkel,$tmp_lahir,$tgl_lahir,$mapel);
					echo $this->session->set_flashdata('msg','success');
					redirect('admin/guru');
				}
	...
	function update_guru(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_guru->update_guru($kode,$nip,$nama,$jabatan,$jenkel,$tmp_lahir,$tgl_lahir,$mapel,$photo);
	                    ...
	                    redirect('admin/guru');
							...
							$tgl_lahir=strip_tags($this->input->post('xtgl_lahir'));
							$mapel=strip_tags($this->input->post('xmapel'));
							$this->m_guru->update_guru_tanpa_img($kode,$nip,$nama,$jabatan,$jenkel,$tmp_lahir,$tgl_lahir,$mapel);
							echo $this->session->set_flashdata('msg','info');
							redirect('admin/guru');
	            } 
