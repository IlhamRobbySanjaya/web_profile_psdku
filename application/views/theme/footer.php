            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <img width="150" src="<?php echo base_url(''); ?>assets/images/logo-polije.png" class="rounded" alt="Bima Tech">
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo site_url('artikel'); ?>">Staff</a></li>
                ...
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <ul>
                            <li><a href="https://polije.ac.id/">Politeknik Negeri Jember</a></li>
                            <li><a href="https://sim-online.polije.ac.id/">Sim Online Polije</a></li>
                            <li><a href="https://e-learning.polije.ac.id/">LMS Polije</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-lg-3">
